...
// if everything is ok, try to upload file
	...
	if(strlen($file) > 0){
		...
		$sql = "INSERT INTO `images` (`id`, `broker_id`, `path`, `image_content`) VALUES (NULL, '0', '".$fileName."', '".$fileContents."');";

		if ($conn->query($sql) === TRUE) {
			$last_id = $conn->insert_id;
			//header("Location: ../../admin/dashboard-label-image.php?imageId=".$last_id);
			//die();
