...
<body style="    color: black;
  ...
  <div class=row style="text-align: center;">
	    <img style="width: 10%;
                        height: auto;
                        margin-top: 5%;
                        margin-bottom: 1.5em;" src="./assets/images/uvr.png" >
  </div>
  ...
  <div class=row>
    ...
    font-size: 26px;     margin-bottom: 4%;
    ">Select a project</h1>
		  <div class="row">
                  <div class="col-md-3">
                  ...
                  <div class="col-md-9 pull-md-2">
                    <div class="row">
          			...
          			<?php
          					...
          					$sql = "SELECT * FROM images where broker_id = " . $_SESSION['brokerId'];
          					$result = $conn->query($sql);
          					if ($result->num_rows > 0) {
          						while($row = $result->fetch_assoc()) {
          							  echo "<div class='col-md-4' style='    text-align: center;'>
          									  <div class='box p-a-xs'>
          										<a  onclick='gotoImage(\"".$row['id']."\");' >".$row['image_content']."</a>
                                                 <p style='    margin-top: 4%;'>".$row['alias_name']."</p>
          									  </div>
          									</div>";
          						}
          					}
          					else{
                            						echo "<span style='text-align: center; font-size: 150%; margin-left: 35%;'>No projects uploaded yet!</span>";
                            					}
				...
				<?php
					...
					if ($result->num_rows > 0) {
						while($row = $result->fetch_assoc()) {
							  echo "
								<tr>
							<td style='text-align: center;'>".$row['path']."</td>
							  <td style='text-align: center; height: auto; width: 10%;'>".$row['image_content']."</td>
							  <td style='text-align: center;'><a onclick='gotoImage(\"".$row['id']."\");' class='fancy-button bg-gradient2'><span style='font-size: 73%;'><i class='fa fa-plus'></i> View</span></a></td>
							</tr>";
						}
					}
					else{
						echo "<span style='text-align: center; font-size: 150%; color: white; margin-left: 35%;'>No images uploaded yet!</span>";
					}
